...
import "./globals.css";
import { openingHours, shop, ui } from "@/lib/content";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_US",
    images: [
      { url: "/og.jpg", width: 1200, height: 630, alt: ui.hero.videoAlt },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${geologica.variable} ${golos.variable}`}>
      <body>
        {/*
